...
object MonadStateLaws {
  ...
  fun <F, S, A> laws(MS: MonadState<F, S>, arbA: Arbitrary<A>, arbS: Arbitrary<S>, MA: Monoid<A>, EQ_S: Eq<Kind<F, S>>, EQ_UNIT: Eq<Kind<F, Unit>>, EQ: Eq<Kind<F, A>>, unsafeRun: Kind<F, Int>.() -> Int) =
    laws(MS, arbA, arbS, MA, functionAToBArbitrary(arbA), EQ_S, EQ_UNIT, EQ, unsafeRun)
