...
infix fun Boolean.and(b: Boolean): Property = property() and b.property()
infix fun Boolean.or(b: Boolean): Property = property() or b.property()
infix fun Boolean.and(b: () -> Boolean): Property = property() and b.andThen { it.property() }
infix fun Boolean.or(b: () -> Boolean): Property = property() or b.andThen { it.property() }
infix fun Boolean.and(b: Eval<Boolean>): Property = property() and b.map { it.property() }
infix fun Boolean.or(b: Eval<Boolean>): Property = property() or b.map { it.property() }