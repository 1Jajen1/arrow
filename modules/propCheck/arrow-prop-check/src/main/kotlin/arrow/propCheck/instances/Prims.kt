...
interface ShortArbitrary : Arbitrary<Short> {
    override fun arbitrary(): Gen<Short> = arbitrarySizedShort()
    override fun shrink(fail: Short): Sequence<Short> = shrinkShort(fail)
}

fun Short.Companion.arbitrary(): Arbitrary<Short> = object : ShortArbitrary {}
