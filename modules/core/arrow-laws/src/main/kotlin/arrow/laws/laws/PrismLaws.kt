...
object PrismLaws {
  ...
  fun <A, B> laws(prism: Prism<A, B>, arbA: Arbitrary<A>, arbB: Arbitrary<B>, EQA: Eq<A>, EQ_OPTION_B: Eq<Option<B>>): List<Law> =
    laws(prism, arbA, arbB, functionAToBArbitrary(arbB), EQA, EQ_OPTION_B)
