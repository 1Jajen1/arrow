...
import arrow.propCheck.arbitrary.*
import arrow.propCheck.arbitrary.asciistring.arbitrary.arbitrary
import arrow.propCheck.arbitrary.asciistring.show.show
...
import arrow.propCheck.arbitrary.smart.show.show
import arrow.propCheck.arbitrary.unicodestring.arbitrary.arbitrary
import arrow.propCheck.arbitrary.unicodestring.show.show
import arrow.propCheck.instances.*
import arrow.propCheck.instances.either.arbitrary.arbitrary
import arrow.propCheck.instances.id.arbitrary.arbitrary
import arrow.propCheck.instances.ior.arbitrary.arbitrary
import arrow.propCheck.instances.listk.arbitrary.arbitrary
import arrow.propCheck.instances.mapk.arbitrary.arbitrary
import arrow.propCheck.instances.nonemptylist.arbitrary.arbitrary
import arrow.propCheck.instances.option.arbitrary.arbitrary
import arrow.propCheck.instances.sequencek.arbitrary.arbitrary
import arrow.propCheck.instances.setk.arbitrary.arbitrary
import arrow.propCheck.instances.tuple10.arbitrary.arbitrary
import arrow.propCheck.instances.tuple11.arbitrary.arbitrary
import arrow.propCheck.instances.tuple12.arbitrary.arbitrary
import arrow.propCheck.instances.tuple13.arbitrary.arbitrary
import arrow.propCheck.instances.tuple14.arbitrary.arbitrary
import arrow.propCheck.instances.tuple15.arbitrary.arbitrary
import arrow.propCheck.instances.tuple16.arbitrary.arbitrary
import arrow.propCheck.instances.tuple17.arbitrary.arbitrary
import arrow.propCheck.instances.tuple18.arbitrary.arbitrary
import arrow.propCheck.instances.tuple19.arbitrary.arbitrary
import arrow.propCheck.instances.tuple2.arbitrary.arbitrary
import arrow.propCheck.instances.tuple20.arbitrary.arbitrary
import arrow.propCheck.instances.tuple21.arbitrary.arbitrary
import arrow.propCheck.instances.tuple22.arbitrary.arbitrary
...
import arrow.propCheck.instances.tuple7.arbitrary.arbitrary
import arrow.propCheck.instances.tuple8.arbitrary.arbitrary
import arrow.propCheck.instances.tuple9.arbitrary.arbitrary
import arrow.propCheck.instances.validated.arbitrary.arbitrary
...
fun <A : Any> lookupArbyWithGenerics(klass: Class<A>, l: Nel<Type>): Arbitrary<A> =
  klass.name.let { name ->
    when { // I am keeping the KClass qualified names for now because i might want to use them later ...
      ...
      name == Sequence::class.qualifiedName || name == Sequence::class.java.name ||
        name == SequenceK::class.qualifiedName || name == SequenceK::class.java.name -> lookupArbitraryNParameters(
        klass,
        1,
        l
      ) {
        SequenceK.arbitrary(it[0])
      }
