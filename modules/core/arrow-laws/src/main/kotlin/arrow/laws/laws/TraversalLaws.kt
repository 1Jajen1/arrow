...
object TraversalLaws {
  ...
  fun <A, B : Any> laws(traversal: Traversal<A, B>, arbA: Arbitrary<A>, arbB: Arbitrary<B>, EQA: Eq<A>, EQ_OPTION_B: Eq<Option<B>>, EQ_LIST_B: Eq<ListK<B>>): List<Law> =
    laws(traversal, arbA, arbB, functionAToBArbitrary(arbB), EQA, EQ_OPTION_B, EQ_LIST_B)
